...
parser.add_argument('--src-dir', default='..',
                    help='The directory of the Toontown Journeynite source code.')
parser.add_argument('--server-ver', default='TTJ-1.0',
...
parser.add_argument('--resources-dir', default='../resources',
                    help='The directory of the Toontown Journey resources.')
parser.add_argument('--config-dir', default='../config/release',
                    help='The directory of the Toontown Journey configuration files.')
...
parser.add_argument('modules', nargs='*', default=['otp', 'toontown'],
                    help='The Toontown Journey modules to be included in the build.')
...
# Copy the provided Toontown Journey modules:
