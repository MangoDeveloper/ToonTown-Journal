...
class TownBattleCogPanel(DirectFrame):
    ...
    def __init__(self, id):
        ...
        self.currHpText = DirectLabel(parent = self, text='', pos = (-0.005, 0.01, 0.015), text_scale = 0.045)
        self.healthBar = None
    ...
    def setCurrHpText(self):
        self.setHp(self.suit.getHP())
        self.healthText = (float(self.currHP) +  '/' +  float(self.maxHP))
        self.currHpText['text'] = self.healthText
