...
class NewsManager(DistributedObject.DistributedObject):
	...
	def setdylanbirthdaystart(self):
		base.localAvatar.setSystemMessage(0, TTlocalizer.dylanbirthdaystart)
		
	def setdylanbirthdayend(self):	
		base.localAvatar.setSystemMessage(0, TTlocalizer.dylanbirthdayend)
