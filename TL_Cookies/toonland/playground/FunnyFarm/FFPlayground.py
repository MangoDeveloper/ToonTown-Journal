...
class FFPlayground(Playground.Playground):
    ...
    def detectedPicnicTableSphereCollision(self, picnicBasket):
        if not picnicBasket.fullSeat2doId[picnicBasket.seatNumber]:
    ...
    def enterPicnicBasketBlock(self, picnicBasket):
        ...
        self.trolley = FFPicnicBasket.FFPicnicBasket(self, self.fsm,
         self.picnicBasketDoneEvent, picnicBasket.doId, picnicBasket.seatNumber)
        self.trolley.load()
        self.trolley.enter()
